...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-8">
        ...
        <h1 class="text-2xl font-bold text-slate-800">Edit Vaccine: {{ $vaccine->name }}</h1>
    </div>
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-8">
        ...
        <form method="POST" action="{{ route('admin.vaccines.update', $vaccine) }}" enctype="multipart/form-data">
            ...
            <div class="flex gap-3 mt-6">
                ...
                <button type="submit" class="flex-1 py-3 bg-gradient-to-r from-sky-500 to-blue-600 text-white font-semibold rounded-xl hover:from-sky-600 hover:to-blue-700 text-sm">Update Vaccine</button>
            </div>
        </form>
    </div>
</div>
